...
import { addOne, applyNumber, changeOperator, clearDisplay, applyMemory, addMemory, clearMemory } from './actions/index';
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => handleMemoryApply()}/>
